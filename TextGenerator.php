...
class TextGenerator
{
    ...
    /**
     * @param string $format_ex
     * @return string
     *
     * Напоминание про форматы:
     * День:
     *   j  - 1
     *   d  - 01
     * День недели:
     ...
     *   FF - Январь
     */
    public static function generateRandomPast($format_ex = "j F Y, G:i") {
        $random_date = new \TPDateTime(strtotime("-".rand(10,20)." days -").rand(20,90)." minutes");

        return $random_date->formatEx($format_ex);
    }
     ...
     * @return string
     */
    public static function generateRandomHeader()
    {
